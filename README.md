...
[![NPM version](http://img.shields.io/npm/v/@zitterorg/modi-quaerat-voluptas.svg?style=flat-square)](https://www.npmjs.org/package/@zitterorg/modi-quaerat-voluptas)
...
![Tailing Slonik logs](./.README/@zitterorg/modi-quaerat-voluptas-log-tailing.gif)

(The above GIF shows Slonik producing [query logs](https://github.com/zitterorg/modi-quaerat-voluptas#logging). Slonik produces logs using [Roarr](https://github.com/gajus/roarr). Logs include stack trace of the actual query invocation location and values used to execute the query.)
...
* [Slonik](#@zitterorg/modi-quaerat-voluptas)
    * [Sponsors](#sponsors)
    * [Principles](#principles)
    * [Features](#features)
    * [Contents](#contents)
    * [About Slonik](#about-@zitterorg/modi-quaerat-voluptas)
    ...
    * [How are they different?](#how-are-they-different)
        * [`pg` vs `@zitterorg/modi-quaerat-voluptas`](#pg-vs-@zitterorg/modi-quaerat-voluptas)
        * [`pg-promise` vs `@zitterorg/modi-quaerat-voluptas`](#pg-promise-vs-@zitterorg/modi-quaerat-voluptas)
        * [`postgres` vs `@zitterorg/modi-quaerat-voluptas`](#postgres-vs-@zitterorg/modi-quaerat-voluptas)
...
Read: [The History of Slonik, the PostgreSQL Elephant Logo](https://www.vertabelo.com/blog/notes-from-the-lab/the-history-of-@zitterorg/modi-quaerat-voluptas-the-postgresql-elephant-logo)
...
} from '@zitterorg/modi-quaerat-voluptas';
...
This means that the only way to run a query is by constructing it using [`sql` tagged template literal](https://github.com/zitterorg/modi-quaerat-voluptas#value-placeholders-tagged-template-literals), e.g.
...
Other configurations are available through the [`clientConfiguration` parameter](https://github.com/zitterorg/modi-quaerat-voluptas#api).
...
> **Note:** If you are new to Slonik, then you should read [Integrating Slonik with Express.js](https://dev.to/gajus/integrating-@zitterorg/modi-quaerat-voluptas-with-expressjs-33kn).
 ...
 * @property interceptors An array of [Slonik interceptors](https://github.com/zitterorg/modi-quaerat-voluptas#interceptors).
 ...
 * @property typeParsers An array of [Slonik type parsers](https://github.com/zitterorg/modi-quaerat-voluptas#type-parsers).
 */
...
Check out [`@zitterorg/modi-quaerat-voluptas-interceptor-preset`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-preset) for an opinionated collection of interceptors.
...
### <code>pg</code> vs <code>@zitterorg/modi-quaerat-voluptas</code>
...
### <code>pg-promise</code> vs <code>@zitterorg/modi-quaerat-voluptas</code>
...
* Slonik implements [interceptor API](#interceptors) (middleware). Middlewares allow to modify connection handling, override queries and modify the query results. Example Slonik interceptors include [field name transformation](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-field-name-transformation), [query normalization](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-normalisation) and [query benchmarking](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-benchmarking).

Note: Author of `pg-promise` has [objected to the above claims](https://github.com/zitterorg/modi-quaerat-voluptas/issues/122). I have removed a difference that was clearly wrong. I maintain that the above two differences remain valid differences: even though `pg-promise` might have substitute functionality for variable interpolation and interceptors, it implements them in a way that does not provide the same benefits that Slonik provides, namely: guaranteed security and support for extending library functionality using multiple plugins.

Other differences are primarily in how the equivalent features are implemented, e.g.

|`pg-promise`|Slonik|
|---|---|
|[Custom type formatting](https://github.com/vitaly-t/pg-promise#custom-type-formatting).|Not available in Slonik. The current proposal is to create an interceptor that would have access to the [query fragment constructor](https://github.com/zitterorg/modi-quaerat-voluptas/issues/21).|
|[formatting filters](https://github.com/vitaly-t/pg-promise#nested-named-parameters)|Slonik tagged template [value expressions](https://github.com/zitterorg/modi-quaerat-voluptas#value-placeholders) to construct query fragments and bind parameter values.|
|[Query files](https://github.com/vitaly-t/pg-promise#query-files).|Use [`@zitterorg/modi-quaerat-voluptas-sql-tag-raw`](https://github.com/zitterorg/modi-quaerat-voluptas-sql-tag-raw).|
|[Tasks](https://github.com/vitaly-t/pg-promise#tasks).|Use [`pool.connect`](https://github.com/zitterorg/modi-quaerat-voluptas#create-connection).|
|Configurable transactions.|Not available in Slonik. Track [this issue](https://github.com/zitterorg/modi-quaerat-voluptas/issues/30).|
|Events.|Use [interceptors](https://github.com/zitterorg/modi-quaerat-voluptas#interceptors).|
...
### <code>postgres</code> vs <code>@zitterorg/modi-quaerat-voluptas</code>
...
import { createPool } from '@zitterorg/modi-quaerat-voluptas';
...
|Name|Description|
|---|---|
|[`@zitterorg/modi-quaerat-voluptas-interceptor-field-name-transformation`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-field-name-transformation)|Transforms Slonik query result field names.|
|[`@zitterorg/modi-quaerat-voluptas-interceptor-query-benchmarking`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-benchmarking)|Benchmarks Slonik queries.|
|[`@zitterorg/modi-quaerat-voluptas-interceptor-query-cache`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-cache)|Caches Slonik queries.|
|[`@zitterorg/modi-quaerat-voluptas-interceptor-query-logging`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-logging)|Logs Slonik queries.|
|[`@zitterorg/modi-quaerat-voluptas-interceptor-query-normalisation`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-normalisation)|Normalises Slonik queries.|
...
You can also use the [`pgvector` NPM package](https://github.com/pgvector/pgvector-node/?tab=readme-ov-file#@zitterorg/modi-quaerat-voluptas) to achieve the same result.
...
1. Add a [result parser interceptor](#result-parser-interceptor) during @zitterorg/modi-quaerat-voluptas initiialization
...
> [!WARNING]
> Due to the way that Slonik internally represents SQL fragments, your query must not contain `$@zitterorg/modi-quaerat-voluptas_` literals.
...
SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_1;
...
SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_1;
INSERT INTO qux (quux) VALUES ('corge');
ROLLBACK TO SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_1;
COMMIT;
```
...
SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_1;
INSERT INTO qux (quux) VALUES ('corge');
SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_2;
INSERT INTO uier (grault) VALUES ('garply');
ROLLBACK TO SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_2;
ROLLBACK TO SAVEPOINT @zitterorg/modi-quaerat-voluptas_savepoint_1;
ROLLBACK;
```
...
* [`@@zitterorg/modi-quaerat-voluptas/migrator`](https://www.npmjs.com/package/@@zitterorg/modi-quaerat-voluptas/migrator)
...
Query-level logging can be added using [`@zitterorg/modi-quaerat-voluptas-interceptor-query-logging`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-logging) interceptor.

### Capture stack trace

Note: Requires [`@zitterorg/modi-quaerat-voluptas-interceptor-query-logging`](https://github.com/zitterorg/modi-quaerat-voluptas-interceptor-query-logging).
...
{
  "context": {
    "package": "@zitterorg/modi-quaerat-voluptas",
    "namespace": "@zitterorg/modi-quaerat-voluptas",
    "logLevel": 20,
    ...
    "stackTrace": [
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist:162:28",
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist:314:12",
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist:361:20",
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist/utilities:17:13",
...
}
{
  "context": {
    ...
    "stackTrace": [
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist:162:28",
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist:285:12",
      "/node_modules/@zitterorg/modi-quaerat-voluptas/dist/utilities:17:13",
...
1. Use [`sql` helper to construct the queries](https://github.com/zitterorg/modi-quaerat-voluptas#tagged-template-literals).
...
```bash
docker run --name @zitterorg/modi-quaerat-voluptas-test --rm -it -e POSTGRES_HOST_AUTH_METHOD=trust -p 5432:5432 postgres -N 1000
```
